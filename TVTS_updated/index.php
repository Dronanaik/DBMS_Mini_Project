...
<section class="main-section client-part" id="client">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h4 style="font-style: italic; color: white;" id="ourname"> HI WE ARE BHASKAR M & DRONA L ,MAKER OF THIS TRAFFIC VIOLATION  TRACKING  SYSTEM  WEBSITE. THIS IS A MINI PROJECT OF DBMS</h4>
            </div>
        </div>
        <ul class="client wow fadeIn delay-05s">
            <li><a href="#">
                <img src="img/bhaskar.jpg" height="130" width="135" alt="">
                <h3>Bhaskar M</h3>
            </a></li>
            <li><a href="#">
                <img src="img/drona.jpg" height="130" width="135" alt="">
                <h3>Drona L</h3>
            </a></li>
        </ul>
    </div>
